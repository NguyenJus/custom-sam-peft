...
def test_predicted_bytes_eval_mode_excludes_optimizer_and_adapter(monkeypatch) -> None:
    ...
    train_bytes = _predicted_bytes("lora", r=4, batch=1, image_size=1008, cache=None, mode="train")
    eval_bytes = _predicted_bytes("lora", r=4, batch=1, image_size=1008, cache=None, mode="eval")
